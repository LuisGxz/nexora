// Nexora — Tailwind theme.extend
// Derived from tokens/design-tokens.json (source of truth). Paste into tailwind.config.js.
// Requires Google Fonts: Space Grotesk + Inter (see typography/typography.md).
...
module.exports = {
  colors: {
    navy: {
      950: '#070C1C',
      900: '#0B1530', // brand base / dark bg
      800: '#111E3D', // dark surface
      700: '#1B294F', // dark border
      600: '#293B66',
      500: '#3B4F7E',
      DEFAULT: '#0B1530',
    },
    blue: {
      700: '#1D4FD7', // primary hover
    ...
    cyan: { DEFAULT: '#22D3EE' },   // secondary accent — use sparingly
    slate: { DEFAULT: '#5B6470' },  // muted text
    whatsapp: '#25D366',
    // semantic aliases
    background: '#F8FAFC',
    surface: '#FFFFFF',
